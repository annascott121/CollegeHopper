...
public class ListPanel extends ControlPanel {
	...
	public void addDataPanel() {
		...
		JLabel consLabel = new JLabel("Optimize routes for:");
		consLabel.setFont(new Font("Sans Serif", Font.BOLD, 24));
...
//		costFuncSect.add(time);
		...
		ButtonGroup constraints = new ButtonGroup();
...
// ******************* Adding and Formatting **********************************
		layout.setHorizontalGroup(layout
				...
				.addGroup(
						layout.createParallelGroup(GroupLayout.Alignment.CENTER)
								.addComponent(consLabel).addComponent(costFuncSect))
				.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED,
						GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addComponent(go));
